...
public class ProductResourceIntTest {
    ...
    private static final String DEFAULT_VTSZ = "AAAAAAAAAA";
    private static final String UPDATED_VTSZ = "BBBBBBBBBB";
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getNetPrice()).isEqualTo(DEFAULT_NET_PRICE);
        assertThat(testProduct.getVtsz()).isEqualTo(DEFAULT_VTSZ);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].vtsz").value(hasItem(DEFAULT_VTSZ.toString())));
    }
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.vtsz").value(DEFAULT_VTSZ.toString()));
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getNetPrice()).isEqualTo(UPDATED_NET_PRICE);
        assertThat(testProduct.getVtsz()).isEqualTo(UPDATED_VTSZ);
