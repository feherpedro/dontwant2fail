...
describe('OrderEntity e2e test', () => {
    ...
    it('should load create OrderEntity dialog', () => {
        ...
        expect(orderEntityDialogPage.getModalTitle())
            .toMatch(/dontwant2FailApp.orderEntity.home.createOrEditLabel/);
    ...
    it('should create and save OrderEntities', () => {
        ...
        orderEntityDialogPage.storeSelectLastOption();
...
export class OrderEntityComponentsPage {
    ...
    title = element.all(by.css('jhi-order-entity-mag div h2 span')).first();
...
export class OrderEntityDialogPage {
    ...
    storeSelect = element(by.css('select#field_store'));
    ...
    storeSelectLastOption = function() {
        this.storeSelect.all(by.tagName('option')).last().click();
    };

    storeSelectOption = function(option) {
        this.storeSelect.sendKeys(option);
    };

    getStoreSelect = function() {
        return this.storeSelect;
    };

    getStoreSelectedOption = function() {
