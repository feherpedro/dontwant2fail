...
describe('Service Tests', () => {
    ...
    describe('ProductStorageMag Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProductStorageMagService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/product-storages';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProductStorageMag', () => {
